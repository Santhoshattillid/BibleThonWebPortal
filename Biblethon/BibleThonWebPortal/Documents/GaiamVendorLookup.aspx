<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GaiamVendorLookup.aspx.cs"
    Inherits="GaiamVendorLookup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Gaiam Vendor Lookup</title>
    <style type="text/css">
        html, body, form
        {
            padding: 0;
        ...
        <script type="text/javascript">
            ...
            function returnToParent() {
                ...
                for (var i = 0; i < selectedRows.length; i++) {
                    ...
                    var cell = MasterTable.getCellByColumnUniqueName(row, "VENDORID")
            ...
            <tr>
                <td>
                    <telerik:RadGrid ID="RadGrid1" runat="server" CellSpacing="0" GridLines="None" Width="100%" AllowPaging="true" AllowFilteringByColumn="true"  OnColumnCreating="RadGrid1_ColumnCreating"
                        ...
                        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="VENDORID">                                                                                    
                        </MasterTableView>
                        <ClientSettings>
