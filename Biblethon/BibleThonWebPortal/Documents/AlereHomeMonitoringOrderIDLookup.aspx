<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlereHomeMonitoringOrderIDLookup.aspx.cs"
    Inherits="AlereHomeMonitoringOrderIDLookup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Alere Home Monitoring Order Lookup</title>
    <style type="text/css">
        html, body, form
        {
            padding: 0;
        ...
        <fieldset id="fld1">
            <div style="margin: 20px 0 0 0;">
                <table>
                    ...
                    <tr>
                        <td align="right">
                            <asp:Label ID="lblOrderID" runat="server" Width="300px" Visible="false"></asp:Label>
