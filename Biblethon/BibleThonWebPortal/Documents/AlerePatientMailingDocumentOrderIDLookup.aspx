<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlerePatientMailingDocumentOrderIDLookup.aspx.cs"
    Inherits="AlerePatientMailingDocumentOrderIDLookup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Alere Patient Mailing Order Lookup</title>
    <style type="text/css">
        html, body, form
        {
            padding: 0;
...
<body onload="AdjustRadWidow();">
        ...
        <script type="text/javascript">
            ...
            function returnToParent() {
                ...
                for (var i = 0; i < selectedRows.length; i++) {
                    ...
                    var cell = MasterTable.getCellByColumnUniqueName(row, "PatientID")
    ...
    <div style="width: 400px; height: 193px;">
        ...
        <table width="100%">
            <tr>
                <td>
                    <telerik:RadGrid ID="RadGrid1" runat="server" CellSpacing="0" GridLines="None" Width="100%" AllowPaging="true" AllowFilteringByColumn="true"  OnColumnCreating="RadGrid1_ColumnCreating"
                        ...
                        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="ORDERID">                                                                                    
                        </MasterTableView>
                        <ClientSettings>
            ...
            <tr>
                <td align="right">
                    <asp:Label ID="lblPatient" runat="server" Width="300px" Visible="true"></asp:Label>
