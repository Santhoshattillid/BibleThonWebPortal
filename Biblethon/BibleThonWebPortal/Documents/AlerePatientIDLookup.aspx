<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AlerePatientIDLookup.aspx.cs"
    Inherits="AlerePatientIDLookup" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Alere Patient Lookup</title>
    <style type="text/css">
        html, body, form
        {
            padding: 0;
            ...
            <tr>
                <td>
                    <telerik:RadGrid ID="RadGrid1" runat="server" CellSpacing="0" GridLines="None" Width="100%" AllowPaging="true" AllowFilteringByColumn="true"  OnColumnCreating="RadGrid1_ColumnCreating"
                        ...
                        <MasterTableView AutoGenerateColumns="False" ClientDataKeyNames="PATIENTID">                                                                                    
                        </MasterTableView>
                        <ClientSettings>
