<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Alere_Patient_Mailing_Items_List.aspx.cs"
    Inherits="Alere_Patient_Mailing_Items_List" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Alere Patient Mailing Items List</title>
    <style type="text/css">
        html, body, form
        {
            padding: 0;
...
<body onload="AdjustRadWidow();">
    ...
    <div>
        ...
        <telerik:RadGrid runat="server" ID="RadGrid1" DataSourceID="LinqDataSource1" AllowAutomaticUpdates="True"
            ...
            GridLines="None">
            <MasterTableView DataKeyNames="ItemSKU" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnCurrentPage"
...
<ExpandCollapseColumn Visible="True" FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
                <Columns>
                    <telerik:GridBoundColumn DataField="ItemSKU" 
                        FilterControlAltText="Filter ItemSKU column" HeaderText="Item" 
                        ReadOnly="false" SortExpression="ItemSKU" UniqueName="ItemSKU">
...
<FilterMenu EnableImageSprites="False"></FilterMenu>
        ...
        <asp:LinqDataSource ID="LinqDataSource1" runat="server" ContextTypeName="AlerePatientMailingDataDataContext"
            ...
            TableName="AS_Alere_PMWF_ItemLists" EntityTypeName="">
        </asp:LinqDataSource>
    </div>
    </form>
</body>
