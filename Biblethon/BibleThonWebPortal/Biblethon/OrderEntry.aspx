                                ...
                                <td class="halftd">
                                    <table class="hafdiv">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCustName" for="LblBName" runat="server" CssClass="txtarea required"></asp:TextBox>
                                            </td>
                                            <td>
                                ...
                                <td class="halftd">
                                    <table class="hafdiv">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCreditCardNo" runat="server" CssClass="required txtarea" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                ...
                                <td class="halftd">
                                    <table class="hafdiv">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox runat="server" ID="TxtOrderNumber" ReadOnly="True" CssClass="txtarea readOnly currencyfield"></asp:TextBox>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
