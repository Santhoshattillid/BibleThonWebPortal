                ...
                <div class="accordion">
                                ...
                                <td class="halftd">
                                    <table class="hafdiv">
                                        ...
                                        <tr id="tr1" runat="server">
                                            ...
                                            <td colspan="2">
                                                <asp:Label ID="lblAddress1" for="LblBAddress1" runat="server" Text=""></asp:Label>
                                                <input type="text" for="LblBAddress1,lblAddress1"  name="TxtBillingAddress1" class="hidden txtarea" id="TxtBillingAddress1"/>
                                            </td>
                                        </tr>
                                        <tr id="tr2" runat="server">
                                            ...
                                            <td colspan="2">
                                                ...
                                                <input type="text" for="LblBAddress2,lblAddress2" name="TxtBillingAddress2" class="hidden txtarea" id="TxtBillingAddress2"/>
                                            </td>
                                        </tr>
                                        <tr id="tr3" runat="server">
                                            ...
                                            <td colspan="2">
                                                ...
                                                <input type="text" for="LblBAddress3,lblAddress3" name="TxtBillingAddress3" class="hidden txtarea" id="TxtBillingAddress3"/>
                                            </td>
                                        </tr>
                                        <tr id="tr4" runat="server">
                                            ...
                                            <td colspan="2">
                                                ...
                                                <input type="text" for="LblBAddress3,lblAddress3" name="TxtBillingCity" class="hidden" id="TxtBillingCity"/>
                                            </td>
                                        </tr>
                    ...
                    <div class="divAccordian OffLinesAccordion">
                        <table>
                            <tr>
                                <td>
                                    <telerik:RadGrid ID="RadGridOfferLines" runat="server" AutoGenerateColumns="False" PagerStyle=""
                                        PageSize="10" AllowPaging="True" OnPageIndexChanged="RadGridOfferLinesDataBinding" CssClass="radGrid">
                                        <MasterTableView>
                                            <Columns>
                                                ...
                                                <telerik:GridTemplateColumn HeaderText="Quantity" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right">
                                                    <ItemTemplate>
                                                        <asp:TextBox runat="server" ID="TxtQuantity" Text='<%# Eval("Quantity") %>' CssClass="txtarea currencyfield"></asp:TextBox>
                                                    </ItemTemplate>
                                                </telerik:GridTemplateColumn>
                                                <telerik:GridBoundColumn UniqueName="Price" HeaderText="Price" DataField="Price" DataFormatString="{0:c}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right" >
                                                </telerik:GridBoundColumn>
                                                <telerik:GridBoundColumn UniqueName="Total" HeaderText="Total" DataField="Total" DataFormatString="{0:c}" ItemStyle-HorizontalAlign="Right" HeaderStyle-HorizontalAlign="Right">
                                                </telerik:GridBoundColumn>
                                            </Columns>
                                        </MasterTableView>
                                    </telerik:RadGrid>
                        ...
                        <table class="total">
                            <tr>
                                ...
                                <td class="totalright">
                                    <asp:TextBox ID="lblTotal" CssClass="txtarea currencyfield" runat="server" EnableViewState="True" ReadOnly="True">
                                    </asp:TextBox>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="totalright">
                                    <asp:TextBox ID="lblGrandTotal" runat="server" CssClass="txtarea currencyfield"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                        <table class="buttunback">
                                ...
                                <td class="halftd">
                                    <table class="hafdiv">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCreditCardNo" for="LblCreditCardNo" runat="server" CssClass="required txtarea" MaxLength="19" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                                <td class="halftd">
                                    <table class="hafdiv">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExpirationDate" for="LblCreditExpired" runat="server" CssClass="required txtarea" MaxLength="4" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label">
                    ...
                    <h3>
                        <a id="4" href="#" class="orderConfirmationAccordion">Total, Confirmation and Order Submission </a>
                    </h3>
