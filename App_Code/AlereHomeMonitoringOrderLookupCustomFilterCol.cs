...
/// <summary>
/// Summary description for AlereOrderLookupCustomFilterCol
/// </summary>
public class AlereHomeMonitoringOrderLookupCustomFilterCol : GridBoundColumn
{    
    ...
    private void list_ItemsRequested(object o, RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        ((RadComboBox)o).DataSource = GetDataTable("SELECT DISTINCT " + this.UniqueName + " FROM AS_WF_VW_AlereOrderLookup WHERE " + this.UniqueName + " LIKE '" + e.Text + "%'");
