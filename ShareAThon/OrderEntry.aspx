...
<body onload="HideMonthlyCharge()">
    ...
    <div class="main">
        <div class="container">
            <div class="leftcolumn">
                ...
                <%-- <p>
                    <a href="../ActionComment.aspx">ActionComment.aspx</a></p>--%>
                <h3>
                    Donation
                </h3>
                <p>
            ...
            <div class="accordionarea">
                ...
                <div class="accordion">
                    ...
                    <!--Donation -->
                    <h3>
                        <a id="1" href="#" class="ShippingAddressAccordion">Donation </a>
                    </h3>
                            ...
                            <tr>
                                <td class="halftd">
                                    <table class="hafdiv">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="drpFrequency" runat="server" OnChange="myFunction()" CssClass="required txtarea">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtExplanation" runat="server" Text="" CssClass="required txtarea"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtCurDonor" runat="server" Text="" CssClass="required txtarea"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label">
                                ...
                                <td class="halftd">
                                    <table class="hafdiv">
                                        <tr>
                                            <td colspan="2">
                                                <asp:CheckBox ID="CheckBox1" Text="May use as challenge" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtDonationAmt" for="LblSAEmail" runat="server" CssClass="required email txtarea"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label">
                                            ...
                                            <td>
                                                <asp:TextBox ID="txtIncreasing" runat="server" CssClass="required readOnly txtarea"></asp:TextBox>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="label">
                                            ...
                                            <td>
                                                <asp:DropDownList ID="DropDownList1" runat="server" OnChange="ShowChargeMonthly()"
                                                    CssClass="required txtarea">
                                                    <asp:ListItem>Mail</asp:ListItem>
                                                    <asp:ListItem>Will bring to churchk</asp:ListItem>
                                                ...
                                                <MasterTableView>
                                                    <Columns>
                                                        ...
                                                        <telerik:GridTemplateColumn HeaderText="Quantity" ItemStyle-HorizontalAlign="Right"
                                                            ...
                                                            <ItemTemplate>
                                                                <asp:TextBox runat="server" ID="TxtQuantity" Text='<%# Eval("Quantity") %>' CssClass="txtarea quantity"></asp:TextBox>
                                                            </ItemTemplate>
                                                        </telerik:GridTemplateColumn>
                                                        <telerik:GridBoundColumn UniqueName="Price" HeaderText="Price" DataField="Price" Visible="False"
                                ...
                                <td class="halftd">
                                    <table class="hafdiv">
                                        <tr>
                                            ...
                                            <td>
                                                <asp:DropDownList ID="ddlCreditCardType" runat="server" OnChange="myFunction()" CssClass="required txtarea">
                        ...
                        <table class="buttunback">
                            <tr>
                                <td colspan="4">
                                    ...
                                    <asp:Button ID="btnSaveOrder" runat="server" Text="Save" CssClass="btn" OnClick="OrderEntrySave" />
                                    <asp:Button ID="btnProcessOrder" runat="server" Text="Process" CssClass="btn" />
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    <script src="../ShareAThon/Scripts/jquery-1.8.3.js" type="text/javascript"></script>
    <script src="../ShareAThon/Scripts/jquery.validate.min.js" type="text/javascript"></script>
    <script src="../ShareAThon/Scripts/contentScript.js" type="text/javascript"></script>
    </form>
</body>
</html>
