        ...
        <ul class="login-form">
            ...
            <li>
                <table>
                    <tr>
                        <td align="left">
                            <label style="width:90px; text-align:left;">
                                Email Address:</label>
                        </td>
                        <td>
                            <telerik:RadTextBox runat="server" ID="txtEmailAddress" Width="160px" />
                        </td>
                    </tr>                    
                    <tr>
                        <td colspan="2" align="right">
                            <telerik:RadAjaxPanel ID="pnl1" runat="server">
                                <telerik:RadButton ID="RadButton1" runat="server" Text="Request New Password" OnClick="Button1_Click">
                                </telerik:RadButton>
