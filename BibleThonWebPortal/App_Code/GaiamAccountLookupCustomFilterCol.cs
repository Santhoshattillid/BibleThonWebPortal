...
/// </summary>
public class GaiamAccountLookupCustomFilterCol : GridBoundColumn
{    
    ...
    private void list_ItemsRequested(object o, RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        ((RadComboBox)o).DataSource = GetDataTable("SELECT DISTINCT TOP 1000  " + this.UniqueName + " FROM RM00101 WHERE " + this.UniqueName + " LIKE '" + e.Text + "%' AND CUSTCLAS NOT LIKE 'SPRI%' AND CUSTCLAS <> 'MUNIC/MLTY' AND CUSTCLAS <> 'TRADESHOWS'");
