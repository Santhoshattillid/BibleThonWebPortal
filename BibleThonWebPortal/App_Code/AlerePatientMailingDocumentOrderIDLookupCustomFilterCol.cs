...
/// </summary>
public class AlerePatientMailingDocumentOrderIDLookupCustomFilterCol : GridBoundColumn
{    
    ...
    private void list_ItemsRequested(object o, RadComboBoxItemsRequestedEventArgs e)
    {
        ...
        ((RadComboBox)o).DataSource = GetDataTable("SELECT DISTINCT TOP 1000  " + this.UniqueName + " FROM AS_Alere_PMWF_Orders WHERE CONVERT(VARCHAR(25), " + this.UniqueName + ", 120) LIKE '" + e.Text + "%'");
