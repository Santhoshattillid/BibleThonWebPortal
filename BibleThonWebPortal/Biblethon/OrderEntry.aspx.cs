...
namespace Biblethon
{
    public partial class BiblethonOrderEntry : Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            LblOperator.Text = Session["LoggedInUser"] != null ? Session["LoggedInUser"].ToString() : string.Empty;
        ...
        protected void BtnSaveOrderClick(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    // once validation success , start generating sales order
                    orderNo = econnectModel.GetNextSalseDocNumber(Utilities._connString).Trim();

                    // getting expireDate
                    DateTime expireDate;
                    DateTime.TryParse(txtExpirationDate.Text.Substring(0, 2) + "/01/" + txtExpirationDate.Text.Substring(2, 2), out expireDate);
                    ...
                    if (new EConnectModel().SerializeSalesOrderObject(fileName,
                                                                      ...
                                                                      listOrders,
                                                                      new CardDetails(
                                                                          ddlCreditCardType.SelectedValue.ToString(CultureInfo.InvariantCulture),
                    ...
                    else
                    {
                        ...
                        // roll back order from GP if it generates for processing.
            ...
            {
                lblError.Text = Resource.ORDER_ENTRY_ERROR + ex.Message;
        ...
        protected void BtnProcessOrderClick(object sender, EventArgs e)
        {
            ...
            if (ValidatePageFields())
            {
                ...
                // initiating orderDetails
                var orderDetails = new SessionOrderDetails
                                       {
                                           CustomerName = txtCustName.Text.Trim(),
                                           ListOrders = GetOrderedItems(string.Empty),
                                           CardDetails =
                                               new CardDetails(
                                               ddlCreditCardType.SelectedValue.ToString(CultureInfo.InvariantCulture),
                                               txtCreditCardNo.Text.Trim(), expireDate, string.Empty),
                                           OrderGrandTotal = Convert.ToDecimal(HdnGrandTotal.Value.Replace("$", "")),
                                           OrderProcess = GetCustomerHeader(string.Empty)
                                       };

                // Pushing order details to session
        ...
        /// <summary>
        /// Rad Grid data binding for Offer lines
        /// </summary>
        ...
        /// <summary>
        /// To get list of Order items from RadGrid
        /// </summary>
        /// <param name="orderNumber"></param>
        /// <returns></returns>
        ...
        private bool ValidatePageFields()
        {
            ...
            {
                lblError.Text = Resource.CITY_FIELD_EMPTY_ERROR_INFO;
                hidAccordionIndex.Value = "1";
                return false;
            }
            ...
            {
                lblError.Text = Resource.STATE_FIELD_EMPTY_ERROR_INFO;
                hidAccordionIndex.Value = "1";
                return false;
            }
            ...
            {
                lblError.Text = Resource.COUNTRY_FIELD_EMPTY_ERROR_INFO;
                hidAccordionIndex.Value = "1";
                return false;
            }
            ...
            {
                lblError.Text = Resource.ZIP_FIELD_EMPTY_ERROR_INFO;
                hidAccordionIndex.Value = "1";
                return false;
            }
            ...
            {
                lblError.Text = Resource.PRODUCTS_FIELD_EMPTY_ERROR_INFO;
            ...
            {
                lblError.Text = Resource.CREDITCARDNUMBER_FIELD_EMPTY_ERROR_INFO;
                hidAccordionIndex.Value = "3";
                return false;
            }
            ...
            {
                lblError.Text = Resource.CREDITCARDEXPIRE_FIELD_EMPTY_ERROR_INFO;
                hidAccordionIndex.Value = "3";
                return false;
            }
