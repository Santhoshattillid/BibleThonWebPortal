<%@ Page Language="C#" AutoEventWireup="true" CodeFile="frmAlereVOBDocument.aspx.cs"
    Inherits="frmAlereVOBDocument" %>
...
<body onload="changeScreenSize(1200,1200)">
    ...
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server" LoadingPanelID="RadAjaxLoadingPanel1">
        ...
        <table width="100%" runat="server">
            <tr style="height: 20px;">
                <td rowspan="2" class="previewWrapper" valign="top">
                    ...
                    <uc1:ShareathonSummaryCtrl ID="previewControltwo" runat="server" />
                </td>
            </tr>
            <tr style="height: 600px;">
                <td class="tabWrapper" valign="top">
                    <telerik:RadPanelBar runat="server" ID="RadPanelBar1" ExpandMode="SingleExpandedItem"
                        Width="800px">
                        <Items>
                            <telerik:RadPanelItem Expanded="True" Text="Patient Information" runat="server" Selected="true">
                                <ContentTemplate>
                                    <div id="Div1" class="text" style="background-color: #edf9fe" runat="server">
                                        <table id="Table1" class="tblMain" runat="server">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <asp:Label ID="Label1" runat="server" AssociatedControlID="txtPrimaryPhone" Text="Primary Phone"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblPhysician" runat="server" AssociatedControlID="txtPhysician" Text="Physician"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <telerik:RadTextBox ID="RadTextBox1" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                                    <telerik:RadTextBox ID="txtPhysician" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblPrimaryDX" runat="server" AssociatedControlID="txtPrimaryDx" Text="Primary Dx"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblSecondaryDx" runat="server" AssociatedControlID="txtSecondaryDx"
                                                        Text="Secondary Dx"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="Label3" runat="server" AssociatedControlID="dtDueDate" Text="Due Date"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <telerik:RadTextBox ID="txtPrimaryDx" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                                    <telerik:RadTextBox ID="txtSecondaryDx" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblPrimaryInsurance" runat="server" AssociatedControlID="txtPrimaryInsurance"
                                                        Text="Primary Insurance"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblPrimaryInsurancePhone" runat="server" AssociatedControlID="txtPrimaryInsurancePhone"
                                                        Text="Primary Insurance Phone"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblPSTMeterType" runat="server" AssociatedControlID="txtPSTMeterType"
                                                        Text="PST Meter Type"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <telerik:RadTextBox ID="txtPrimaryInsurance" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                                    <telerik:RadTextBox ID="txtPrimaryInsurancePhone" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                                    <telerik:RadTextBox ID="txtPSTMeterType" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblSecondaryInsurance" runat="server" AssociatedControlID="txtSecondaryInsurance"
                                                        Text="Secondary Insurance"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblSecondaryInsurancePhone" runat="server" AssociatedControlID="txtSecondaryInsurancePhone"
                                                        Text="Secondary Insurance Phone"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblTestFrequency" runat="server" AssociatedControlID="txtTestFrequency"
                                                        Text="Test Frequency"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <telerik:RadTextBox ID="txtSecondaryInsurance" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                                    <telerik:RadTextBox ID="txtSecondaryInsurancePhone" runat="server" Width="170px"
                                                        ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                                    <telerik:RadTextBox ID="txtTestFrequency" runat="server" Width="170px" ReadOnly="true">
                                                    </telerik:RadTextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <br />
                                                    <asp:Label ID="Lab4" runat="server" Text="CLICK +Next to advance to Insurance"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td colspan="3">
                                ...
                                <ContentTemplate>
                                    <div class="text" style="background-color: #edf9fe">
                                        <table class="tblMain">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <telerik:RadTextBox Width="100%" ID="txtDoctorNote" runat="server" TextMode="MultiLine"
                                                        Height="50px" EmptyMessage="Enter Note Here">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <tr>
                                ...
                                <ContentTemplate>
                                    <div class="text" style="background-color: #edf9fe">
                                        <table class="tblMain">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <telerik:RadTextBox Width="100%" ID="txtPatientNote" runat="server" TextMode="MultiLine"
                                                        Height="50px" EmptyMessage="Enter Note Here">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <tr>
                                ...
                                <ContentTemplate>
                                    <div class="text" style="background-color: #edf9fe">
                                        <table class="tblMain">
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <telerik:RadTextBox Width="100%" ID="txtOrderNote" runat="server" TextMode="MultiLine"
                                                        Height="50px" EmptyMessage="Enter Note Here">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <tr>
     ...
     <table class="tblMain">
                                            <tr>
                                                <td>
                                                    <asp:Label ID="lblMedicareID" runat="server" AssociatedControlID="txtMedicareID"
                                                        Text="Medicare ID"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblPartB" runat="server" 
                                                        Text="Part B?"></asp:Label>
                                                </td>
                                                <td>
                                                    <asp:Label ID="lblCoveredDx" runat="server" 
                                                        Text="Covered Dx?"></asp:Label>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    <telerik:RadTextBox ID="txtMedicareID" runat="server" Width="170px" ReadOnly="false">
                                                    </telerik:RadTextBox>
                                                </td>
                                                <td>
                                                   <telerik:RadButton ID="btnPartBYes" runat="server" ToggleType="Radio" Checked="true"
                                                        GroupName="PartBGroup" ButtonType="StandardButton" AutoPostBack="false" Text="Yes">
                                                    </telerik:RadButton>
                                                    <telerik:RadButton ID="btnPartBNo" runat="server" ToggleType="Radio" GroupName="PartBGroup"
                                                        ButtonType="StandardButton" AutoPostBack="false" Text="No">
                                                    </telerik:RadButton>
                                                </td>
                                                <td>
                                                    <telerik:RadButton ID="btnCoveredDxYes" runat="server" ToggleType="Radio" Checked="true"
                                                        GroupName="CoveredDxGroup" ButtonType="StandardButton" AutoPostBack="false" Text="Yes">
                                                    </telerik:RadButton>
                                                    <telerik:RadButton ID="btnCoveredDxNo" runat="server" ToggleType="Radio" GroupName="CoveredDxGroup"
                                                        ButtonType="StandardButton" AutoPostBack="false" Text="No">
                                                    </telerik:RadButton>
                                                </td>
                                            </tr>
                                            ...
                                            <tr>
                                                <td colspan="3">
                                                    <telerik:RadTextBox Width="100%" ID="txtInsuranceNote" runat="server" TextMode="MultiLine"
                                                        Height="50px" EmptyMessage="Enter Note Here">
                                                    </telerik:RadTextBox>
                                                </td>
                                            </tr>
